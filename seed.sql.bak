...
INSERT INTO users (id, school_id, full_name, email, password_hash, role_id, status, created_at, updated_at) VALUES
  ...
  (5, 2, 'محمد حسين', 'accountant@rafidain.iq', '250dc3b4c58b8716c7c775368b08d457f892086968561095dc9dc8bf2be8cada', 6, 'active', unixepoch(), unixepoch()),
  (6, 3, 'نور الدين', 'registrar@eman.iq', '2cda63c1c62537b97faef5aaa06a08ef264b997130a3a3be47202236db8ec76e', 7, 'inactive', unixepoch(), unixepoch())
ON CONFLICT(id) DO NOTHING;
