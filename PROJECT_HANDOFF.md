...
يوجد على `main` عدد 34 ملف migration حتى `0033`، وهي مطبقة على STAGING مرة واحدة وبالترتيب. المصدر المعتمد للترتيب هو أسماء الملفات داخل `migrations/`، بما فيها ملفا `0014` التاريخيان.
...
5. إشعارات الأقساط/النتائج وتوسيع بوابة ولي الأمر بعد قياس استخدام العرض المالي الجديد وموافقات الخصوصية.
6. تقارير قابلة للتخصيص وتصدير مجدول، مع نسخ احتياطي تشغيلي واختبارات استعادة دورية.

Phase 20B وPhase 20C مقبولتان ومندمجتان، وmigrations `0032` و`0033` مطبقتان على STAGING. الخطوة الأكاديمية التالية هي إدخال سياسات حقيقية موثقة للسنة والصفوف ثم تنفيذ دورة نشر النتائج والاعتراض والترحيل في دفعة مستقلة. لا تصل إلى Production قبل قرار GO مستقل.
