...
- Phase 20E.3 قيد المراجعة عبر [PR #48](https://github.com/smartschoolduhok/smart-school/pull/48): تضيف نقل حصص الجدول الأسبوعي بالسحب والإفلات والتبديل الذري عند الإسقاط فوق مادة أخرى. يُسمح بحفظ تعارض المدرّس الناتج عن السحب مع تلوين الحصتين بالوردي المحمر وإظهار «تعارض المدرّس»، بينما تبقى قيود المجموعة وتوفر المدرّس والأحمال والحدود اليومية مانعة. تبقى نافذة اختيار الفترة بديلًا صريحًا للوحة المفاتيح. أضيفت Migration `0037` لهذا السلوك، ولم تُطبّق على STAGING بعد. [عقد التنفيذ والفحص](docs/PHASE_20E3_TIMETABLE_DRAG_DROP_QA.md).
