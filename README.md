...
- Phase 20E.3 قيد التنفيذ: تضيف نقل حصص الجدول الأسبوعي بالسحب والإفلات، والتبديل الذري عند الإسقاط فوق مادة أخرى، مع إعادة فحص قيود المدرس والمجموعة من الخادم ومنع السحب للحصص المثبتة. تبقى نافذة اختيار الفترة بديلًا صريحًا للوحة المفاتيح. لا توجد migration جديدة. [عقد التنفيذ والفحص](docs/PHASE_20E3_TIMETABLE_DRAG_DROP_QA.md).
