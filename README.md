...
- Phase 20E.2 قيد المراجعة: تضيف عشرة قوالب عراقية جاهزة للكتب الرسمية، وحقولًا متغيرة قابلة للمراجعة قبل الإصدار، وترويسة عربية/إنكليزية قابلة للتخصيص مع شعار رسمي اختياري، وقالب A4 موحدًا مع QR وتوقيع وختم. Migration `0036` إضافية ولا تعيد كتابة الكتب السابقة. [تقرير التنفيذ والأدلة](docs/PHASE_20E2_OFFICIAL_BOOK_TEMPLATES_QA.md).
