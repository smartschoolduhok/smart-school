...
- Phase 20E.1 قيد المراجعة في Draft PR `#46`: تضيف تصميم Result Card v7 رسميًا أنظف، وخيارات عرض سنوية أو فصلية أو شهرية أو مخصصة، ونصًا متعدد الأسطر تديره المدرسة أعلى الكارت. الطباعة والـQR يعملان عند إصدار الكارت، بينما «إرسال لولي الأمر» هو الخطوة المنفصلة التي تظهره للحساب المرتبط فقط. نجحت `1516/1516` regression والبناء والتدقيق الأمني، ولا توجد migration جديدة. [تقرير الأدلة](docs/PHASE_20E1_RESULT_CARD_CUSTOMIZATION_QA.md).
