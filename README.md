...
- Phase 21C قيد الإنجاز على `codex/phase-21c-staff-attendance`: تضيف حضور الموظفين والأساتذة كسجل مستقل تمامًا عن حضور الطلبة، مع بطاقة QR موقعة، دخول/خروج، تسجيل يدوي بسبب إلزامي، إبطال مدقق، تقرير للمحاسب للقراءة فقط، وسجل شخصي للمدرس المرتبط. Migration `0040` اجتازت السلسلة المحلية `41/41` ولم تُطبّق على STAGING بعد. [تقرير التنفيذ المحلي وبوابة STAGING](docs/PHASE_21C_STAFF_ATTENDANCE_QA.md).
