...
- Phase 20E.1 منفذة محليًا على فرع مستقل وتنتظر Draft PR/Preview: تضيف تصميم Result Card v7 الحديث، وخيارات عرض سنوية أو فصلية أو شهرية أو مخصصة، ونصًا متعدد الأسطر تديره المدرسة أعلى الكارت مع الحفاظ على الكروت القديمة. نجحت `1511/1511` regression وفحوص D1 والاستعادة والبناء، ولا توجد migration جديدة. [تقرير الأدلة](docs/PHASE_20E1_RESULT_CARD_CUSTOMIZATION_QA.md).
