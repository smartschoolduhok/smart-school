...
يحتوي فرع Phase 21D حاليًا 42 ملف migration مرتبة حتى `0041_homework.sql`. عند إغلاق Phase 21C كان آخر سجل مؤكد على STAGING هو `0040` بعد `41/41`؛ افحص الحالة الحالية مجددًا قبل أي تنفيذ. لا تفترض أن نجاح Local يعني أنها مطبقة عن بعد؛ سجل D1 في كل بيئة هو المصدر الفعلي لحالة الترحيل. بوابة R2 وD1 المقترحة في [PHASE_21D_STAGING_GATE.md](docs/PHASE_21D_STAGING_GATE.md).
