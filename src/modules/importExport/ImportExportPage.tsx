...
const SYSTEM_FIELDS: Record<ImportType, { key: string; label: string; required?: boolean; hint?: string }[]> = {
  ...
  grades: [
    ...
    { key: 'first_term_grade', label: 'درجة الفصل الأول المباشرة' },
    { key: 'first_month', label: 'الشهر الأول' },
    { key: 'second_month', label: 'السعي الثاني' },
    { key: 'mid_year_exam', label: 'درجة نصف السنة' },
    { key: 'second_term_grade', label: 'درجة الفصل الثاني المباشرة' },
...
const AUTO_MAP_RULES: Record<string, string[]> = {
  ...
  first_term_grade: ['درجة الفصل الاول', 'الفصل الاول', 'first_term_grade', 'first term', 'first term grade', 'term 1'],
  first_month: ['السعي الاول', 'الشهر الاول', 'الشهر 1', 'الشهر ١', 'first_month', 'first month', 'first effort'],
  second_month: ['السعي الثاني', 'الشهر الثاني', 'second_month', 'second month', 'second effort'],
  second_term_grade: ['درجة الفصل الثاني', 'الفصل الثاني', 'second_term_grade', 'second term', 'second term grade', 'term 2'],
  third_month: ['السعي الثالث', 'الشهر الثالث', 'الشهر 3', 'الشهر ٣', 'third_month', 'third month', 'third effort'],
