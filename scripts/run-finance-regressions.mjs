...
const names=['finance-fees','security','rbac','resource-access','ui-foundations','settings','academic-years','student-enrollments','student-promotion','student-profile','subject-management','subject-order','religious-subjects','subject-applicability','flexible-grades','grade-presentation','result-cards','excel-import','timetable','teaching-load-matrix','week-setup'];
