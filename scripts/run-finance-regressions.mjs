...
const names=['finance-fees','treasury-payroll','security','rbac','resource-access','ui-foundations','settings','academic-years','student-enrollments','student-promotion','student-profile','subject-management','subject-order','religious-subjects','subject-applicability','flexible-grades','grade-policies','grade-presentation','result-cards','result-publication','excel-import','timetable','teaching-load-matrix','week-setup'];
